...
> Чтобы понять **почему** проект сделан так, как сделан, и где именно в коде сидит каждое стратегическое решение — читай [docs/learning/](docs/learning/). Там 9 карт «глава учебника → код проекта». Юзер прошёл с этим самообучающий курс на 9 глав; в каждой карте я перепроверил утверждения главы против реального кода и зафиксировал расхождения. Это самый быстрый способ для нового агента увидеть проект **с правильными приоритетами**.
